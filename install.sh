#!/bin/sh
# install.sh — download and install the poe-acp binary.
#
...
#   curl -fsSL https://raw.githubusercontent.com/kfet/poe-acp/main/install.sh | VERSION=v0.1.0 sh
#   curl -fsSL https://raw.githubusercontent.com/kfet/poe-acp/main/install.sh | BIN_DIR=$HOME/bin sh
#
...
#   REPO          github owner/repo (default: kfet/poe-acp)
...
#
# On macOS prefer `brew install kfet/ai/poe-acp` — it upgrades with the rest
# of your system. This script is for Linux hosts (Raspberry Pi included).

set -eu

REPO="${REPO:-kfet/poe-acp}"
BIN_NAME="poe-acp"
...
printf '\nnext:\n'
printf '  %s\n' 'poe-acp -h                       # flags and defaults'
printf '  %s\n' 'see https://github.com/kfet/poe-acp#readme for config + deploy'
