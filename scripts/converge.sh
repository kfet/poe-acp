...
LOCAL=0
FORCE_LOCAL=0
# Extra ssh options. Empty for converge (a slow host must not be mistaken for
# a broken one mid-apply); `status` sets a connect timeout so one dead host
# cannot stall a read-only fleet sweep.
SSH_OPTS=""
